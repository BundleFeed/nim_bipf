...
typedef struct tyObject_PathIter__jwAWKNuCwWkXOj6Rt69a9clQ tyObject_PathIter__jwAWKNuCwWkXOj6Rt69a9clQ;
...
struct tyObject_PathIter__jwAWKNuCwWkXOj6Rt69a9clQ {
NI i;
NI prev;
NIM_BOOL notFirst;
};
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, hasNext__pureZpathnorm_6)(tyObject_PathIter__jwAWKNuCwWkXOj6Rt69a9clQ it, NimStringV2 x);
N_LIB_PRIVATE N_NIMCALL(tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ, next__pureZpathnorm_10)(tyObject_PathIter__jwAWKNuCwWkXOj6Rt69a9clQ* it, NimStringV2 x);
...
N_LIB_PRIVATE N_NIMCALL(void, addNormalizePath__pureZpathnorm_74)(NimStringV2 x, NimStringV2* result, NI* state, NIM_CHAR dirSep) {
	tyObject_PathIter__jwAWKNuCwWkXOj6Rt69a9clQ it;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	nimZeroMem((void*)(&it), sizeof(tyObject_PathIter__jwAWKNuCwWkXOj6Rt69a9clQ));
		...
		while (1) {
			...
			LA16_: ;
			{
				...
				LA30_: ;
				{
					...
					LA45_: ;
					colontmpD_ = substr__system_7503(x, b.Field0, b.Field1);
...
appendString((&(*result)), colontmpD_);
			...
			LA49_: ;
			{
				...
				LA58_: ;
				colontmpD__2 = substr__system_7503(x, b.Field0, b.Field1);
...
appendString((&(*result)), colontmpD__2);
	...
	}
	{
		...
		LA63_: ;
		if (!T62_) goto LA64_;
		eqsink___system_3269((&(*result)), TM__DfU0iuayCGwHDN1Exp9cbKg_3);
	}
	LA64_: ;
	}BeforeRet_: ;
}
